...
<form action="board" method="post">
    ...
    <table border="1">
        <c:if test="${boardDTO == null}">
            <tr><th>사원번호</th><td><input type="text" name="empno"></td></tr>
        </c:if>
        <tr><th>제목</th><td><input type="text" name="title" value="${boardDTO.title}"></td></tr>
        <tr><th>내용</th><td><textarea name="content">${boardDTO.boardContent}</textarea></td></tr>
        <tr>
            <th>공지사항</th>
            <td>
                <select name="notice">
